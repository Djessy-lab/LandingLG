<template>
  <div :class="colorMode.value === 'dark' ? 'bg-gray-900' : gradientClass">
    ...
    <section class="text-center py-12">
      ...
      <div v-if="userEmail" class="mt-4 text-lg"
        :class="colorMode.value === 'dark' ? 'text-gray-300' : 'text-gray-800'">
        Bienvenue, {{ userEmail }}!
      </div>
      ...
      <div class="mt-8 sm:w-[80%] lg:w-[60%] mx-auto shadow-2xl rounded-2xl">
